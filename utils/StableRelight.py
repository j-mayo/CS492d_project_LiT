...
#from ..encoders import LightingEncoder
...
class StableRelight(
    ...
    def __init__(
        ...
        #feature_extractor: LightingEncoder
    ...
    def __call__(
        ...
        light_conditioning: torch.Tensor = None, # added
        pose_conditioning: torch.Tensor = None, # added
